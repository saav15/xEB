...
public class MechaVulcanProjectileRenderer extends EntityRenderer<MechaVulcanProjectileEntity> {

    public MechaVulcanProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(MechaVulcanProjectileEntity entity, float entityYaw, float partialTick,
    ...
    @Override
    public ResourceLocation getTextureLocation(MechaVulcanProjectileEntity entity) {
